...
# # shortened task 1
# # comma-separated integers, index == position
# # opcode 1 - adds 0 and 1 into 2 (ints after the opcode 1, they represent the positions in the list from which to read and where to (over)write)
# # opcode 2 - like opcode 1, but it multiplies the numbers
# # after processing an opcode - step forward 4 places (after the last read value)
...
# find pair of numbers at pos 1 and 2 that make the program end in 19690720
# calc 100*noun(1) + verb(2)
